...
/// @nodoc
@JsonSerializable()
class _$HotelDtoImpl extends _HotelDto {
  ...
  @override
  String toString() {
    return 'HotelDto(id: $id, title: $title, description: $description, price: $price, city: $city, country: $country, type: $type, images: $images)';
  }
...
abstract class _HotelDto extends HotelDto {
  const factory _HotelDto(
      ...
      final String? country,
      final String? type,
      final List<ImageModel>? images}) = _$HotelDtoImpl;
  const _HotelDto._() : super._();
