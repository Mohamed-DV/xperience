...
//   const EventsDetailsScreen({super.key, required this.isFromReserved});
...
//     final selectedEvent = ref.watch(reservationRepositoryProvider).event;
...
//                                 onTap: () {
//                                   print(
//                                     'Toggling favorite for event: ${selectedEvent.id}',
//                                   );
//                                   ref
...
//                         itemCount: selectedEvent.images!.length ?? 0,
...
//                       : Stack(
//                         children: [
//                           DetailsScreen(null, null, selectedEvent),
...
class _EventsDetailsScreenState
    extends ConsumerState<EventsDetailsScreen> {
  int _selectedIndex = 0;
  @override
  void initState() {
    super.initState();
  ...
  @override
  Widget build(BuildContext context) {
    final selectedEvent = ref.watch(reservationRepositoryProvider).compition;
              ...
              : Stack(
                children: [
                  ...
                  ref.watch(reservationRepositoryProvider).isLanched
                      ...
                      : Stack(
                        children: [
                          DetailsScreen(selectedEvent, null, null),
                          (selectedEvent.isReserved ?? false) &&
                                  widget.isFromReserved
                              ? const ButtonOnLunch()
                              : ButtonLunch(
