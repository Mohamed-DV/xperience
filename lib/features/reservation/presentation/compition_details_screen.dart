...
class CompitionDetailsScreen extends ConsumerStatefulWidget {
  final bool isFromReserved;
  const CompitionDetailsScreen({super.key, required this.isFromReserved});

  @override
  ConsumerState<CompitionDetailsScreen> createState() =>
      _CompitionDetailsScreenState();
}

class _CompitionDetailsScreenState
    extends ConsumerState<CompitionDetailsScreen> {
