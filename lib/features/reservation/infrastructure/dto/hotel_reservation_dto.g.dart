...
_$HotelReservationDtoImpl _$$HotelReservationDtoImplFromJson(
        Map<String, dynamic> json) =>
    _$HotelReservationDtoImpl(
...
Map<String, dynamic> _$$HotelReservationDtoImplToJson(
        _$HotelReservationDtoImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'user': instance.user,
