...
abstract class $TokenCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, String expiresAt});
}
...
class _$TokenImpl extends _Token {
  const _$TokenImpl({required this.token, required this.expiresAt}) : super._();
...
abstract class _Token extends Token {
  const factory _Token(
      ...
      required final String expiresAt}) = _$TokenImpl;
